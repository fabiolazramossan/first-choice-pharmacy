      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-gray-500 max-w-xl mx-auto">
            Haz clic en una categoría para ver todos los productos disponibles.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
          {PRODUCT_CATEGORIES.map((cat, i) => (
            <motion.div
              ...
              className={"group relative cursor-pointer overflow-hidden rounded-3xl border bg-gradient-to-br " + cat.gradient + " " + cat.border + " p-5 shadow-sm transition-all duration-300 hover:shadow-xl"}
            >
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-sm font-bold leading-tight text-gray-900">{cat.name}</h3>
                <p className="mt-1 text-xs leading-snug text-gray-500">{cat.desc}</p>
                <span className="mt-3 rounded-full bg-white/80 px-3 py-1 text-xs font-semibold text-gray-600 opacity-0 transition-opacity group-hover:opacity-100">
                  Ver productos
                </span>
              </div>
            </motion.div>
        ...
        <div className="mt-12 flex flex-col items-center gap-4 rounded-3xl border border-green-100 bg-green-50 p-8 text-center sm:flex-row sm:text-left">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-bold text-gray-900">¿No encuentras lo que buscas?</h3>
